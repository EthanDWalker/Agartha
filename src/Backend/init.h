...
VkImageCreateInfo ImageCI(VkFormat format, VkImageUsageFlags usage_flags, VkExtent3D extent,
                          uint32_t mip_levels = 1);
VkImageViewCreateInfo ImageViewCI(VkFormat format, VkImageAspectFlags aspect_flags, VkImage image,
                                  uint32_t mip_levels);
